...
func (c *FakeSwarms) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SwarmList, err error) {
	...
	list := &v1alpha1.SwarmList{ListMeta: obj.(*v1alpha1.SwarmList).ListMeta}
	for _, item := range obj.(*v1alpha1.SwarmList).Items {
...
func (c *FakeSwarms) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(swarmsResource, c.ns, name, opts), &v1alpha1.Swarm{})
