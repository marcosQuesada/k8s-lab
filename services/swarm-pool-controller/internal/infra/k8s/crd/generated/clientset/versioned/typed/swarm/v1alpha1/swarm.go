...
import (
	...
	v1alpha1 "github.com/marcosQuesada/k8s-lab/services/swarm-pool-controller/internal/infra/k8s/crd/apis/swarm/v1alpha1"
	scheme "github.com/marcosQuesada/k8s-lab/services/swarm-pool-controller/internal/infra/k8s/crd/generated/clientset/versioned/scheme"
...
// SwarmsGetter has a method to return a SwarmInterface.
...
// swarms implements SwarmInterface
type swarms struct {
...
func (c *swarms) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Swarm, err error) {
	result = &v1alpha1.Swarm{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("swarms").
		Name(name).
...
func (c *swarms) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SwarmList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SwarmList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("swarms").
...
func (c *swarms) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *swarms) Create(ctx context.Context, swarm *v1alpha1.Swarm, opts v1.CreateOptions) (result *v1alpha1.Swarm, err error) {
	result = &v1alpha1.Swarm{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("swarms").
...
func (c *swarms) Update(ctx context.Context, swarm *v1alpha1.Swarm, opts v1.UpdateOptions) (result *v1alpha1.Swarm, err error) {
	result = &v1alpha1.Swarm{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("swarms").
...
func (c *swarms) UpdateStatus(ctx context.Context, swarm *v1alpha1.Swarm, opts v1.UpdateOptions) (result *v1alpha1.Swarm, err error) {
	result = &v1alpha1.Swarm{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("swarms").
...
func (c *swarms) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *swarms) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *swarms) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Swarm, err error) {
	result = &v1alpha1.Swarm{}
