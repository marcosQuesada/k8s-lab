...
import (
	v1alpha12 "github.com/marcosQuesada/k8s-lab/services/swarm-pool-controller/internal/infra/k8s/crd/apis/swarm/v1alpha1"
...
type SwarmLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha12.Swarm, err error)
...
// List lists all Swarms in the indexer.
func (s *swarmLister) List(selector labels.Selector) (ret []*v1alpha12.Swarm, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha12.Swarm))
	})
	return ret, err
}
...
type SwarmNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*v1alpha12.Swarm, error)
...
// List lists all Swarms in the indexer for a given namespace.
func (s swarmNamespaceLister) List(selector labels.Selector) (ret []*v1alpha12.Swarm, err error) {
...
// Get retrieves the Swarm from the indexer for a given namespace and name.
func (s swarmNamespaceLister) Get(name string) (*v1alpha12.Swarm, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha12.Resource("swarm"), name)
	}
	return obj.(*v1alpha12.Swarm), nil
}
